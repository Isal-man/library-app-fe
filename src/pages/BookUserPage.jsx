    ...
    <MainPage>
      ...
      <footer className="flex items-center gap-4">
        ...
        {[["1"], ["2"], ["3"], ["4"], ["5"]].map(([page], i) => (
          <button
            key={i}
            className="xxs:hidden xxs:w-9 xxs:h-9 text-black border border-black bg-transparent rounded-full md:flex justify-center items-center p-2 hover:bg-indigo-500 hover:text-white hover:border-none"
          >
            {page}
          </button>
        ))}
